...
function total() {
    ...
    document.getElementById('Resultado').innerHTML = `<div style="text-align: center;">
        ...
        <br> Total: $${total}
        <br><img src='IMG/Gracias por su compra.png' width='175px' height='175px'></div>`;
